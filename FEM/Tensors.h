...
//enum component_t
//{
// X=1, Y, Z, R, Fi, Ro, Psi, XX, YY, ZZ, XY, YX, YZ, ZY, ZX, XZ
//};
//enum tensor_kind_t
//{
// eZero, eUnit
...
// private:
//   real_t Data[3];
//   void __Assign(real_t v_) {Data[0]=Data[1]=Data[2]=v_;}
//   void __Assign(const real_t* const d_) {Data[0]=d_[0]; Data[1]=d_[1]; Data[2]=d_[2];}
//   void __Assign(const Tensor1s& o_) {Data[0]=o_.Data[0]; Data[1]=o_.Data[1]; Data[2]=o_.Data[2];}
// public:
//   const real_t& operator[](small_t i_) const {return Data[i_];}// is public because need for fFunArgAdapter<1,Targ,Tresult,FUN> for integration
//         real_t& operator[](small_t i_)       {return Data[i_];}
//// public:
//   Tensor1s() {}
//   Tensor1s(tensor_kind_t, small_t, real_t=1.l);//Basis vector multiplied by factor_
//   Tensor1s(     float  x_,      float  y_,      float  z_){Data[0]=x_; Data[1]=y_; Data[2]=z_;}
//   Tensor1s(     double x_,      double y_,      double z_){Data[0]=x_; Data[1]=y_; Data[2]=z_;}
//   Tensor1s(long double x_, long double y_, long double z_){Data[0]=x_; Data[1]=y_; Data[2]=z_;}
//   explicit Tensor1s(real_t v_)              {__Assign(v_);}
//   explicit Tensor1s(const real_t* const);
//   Tensor1s(const Tensor1s& o_){__Assign(o_);}
...
//   Tensor1s& operator= (const Tensor1s& o_) {__Assign(o_); return *this;}
//   Tensor1s& operator-=(const Tensor1s& o_) {Data[0]-=o_[0]; Data[1]-=o_[1]; Data[2]-=o_[2]; return *this;}
//   Tensor1s& operator+=(const Tensor1s& o_) {Data[0]+=o_[0]; Data[1]+=o_[1]; Data[2]+=o_[2]; return *this;}
//   Tensor1s& operator*=(real_t v_)               {Data[0]*=v_; Data[1]*=v_; Data[2]*=v_; return *this;}
//   Tensor1s& operator/=(real_t);
//   Tensor1s operator-() const                       {return Tensor1s(-Data[0], -Data[1], -Data[2]);}
//   Tensor1s operator+(const Tensor1s& o_)const {return Tensor1s(Data[0]+o_[0], Data[1]+o_[1], Data[2]+o_[2]);}
//   Tensor1s operator-(const Tensor1s& o_)const {return Tensor1s(Data[0]-o_[0], Data[1]-o_[1], Data[2]-o_[2]);}
//   Tensor1s operator*(real_t v_) const              {return Tensor1s(Data[0]*v_, Data[1]*v_, Data[2]*v_);}
//   bool     operator==(const Tensor1s& o_) const {return EQ(Data[0],o_[0]) && EQ(Data[1],o_[1]) && EQ(Data[2],o_[2]);}//is used in "DxfStream.cpp"
//   Tensor1s& Negate() {Data[0]=-Data[0]; Data[1]=-Data[1]; Data[2]=-Data[2]; return *this;}
//   real_t   Length() const {return sqrt(Data[0]*Data[0] + Data[1]*Data[1] + Data[2]*Data[2]);}
//   Tensor1s& Normalize()   {return operator/=(Length());}
//   Tensor1s& Assign0  ()   {__Assign(0.l); return *this;}
//   Tensor1s& Assign1  (small_t i_, real_t v_=1.l)    {__Assign(0.l); Data[--i_]=v_; return *this;}
//   Tensor1s& Assign(real_t x_,real_t y_,real_t z_) {Data[0]=x_; Data[1]=y_; Data[2]=z_; return *this;}
//   Tensor1s& Assign(small_t i_,real_t v_) {Data[--i_]=v_; return *this;}// temporarily - to be removed
...
//   Tensor1s* pData;
// private:
//   Tensor1s* __pData() {return is0() ? (pData=new Tensor1s) : pData;}
//   bool __AdjustAdd(const Tensor1a& o_) {return is0() ? (o_.is0() ? false : (pData=new Tensor1s(*o_.pData),false)) : (o_.is0() ? false : true);}
//   template <typename T>
//        bool __AdjustMult(const T& o_) {return is0() ? false : (o_.is0() ? Assign0(),false : true);}
//   template <typename Tfactor, typename Tresult>
//        bool __AdjustMult(const Tfactor& o_, Tresult& r_)const {return is0() || o_.is0()  ?  r_.Assign0(), false : true;}
//   const real_t operator[](small_t i_) const {return is0() ? 0.l : pData->operator[](i_);}
// public:
// //////////////////////// temporarily!!! - only for tNode::LinkDisplacement
//   const Tensor1s* Data() const {return pData;}
// ////////////////////////
//   Tensor1a(): pData(NULL) {}
//   Tensor1a(real_t x_, real_t y_, real_t z_): pData(new Tensor1s(x_,y_,z_)) {}
//   explicit Tensor1a(const Tensor1s& o_): pData(new Tensor1s(o_)) {}
//   Tensor1a(const Tensor1a& o_): pData(o_.is0()? (Tensor1s*)NULL : new Tensor1s(*o_.pData)) {}
//   Tensor1a(RetTensor1&);
//   virtual ~Tensor1a() {delete pData;}
//   bool is0() const {return pData==NULL;}
//   bool is0(small_t) const {return is0();}
//   const real_t& operator()(small_t) const;
//         real_t& operator()(small_t);
//   Tensor1a& operator= (RetTensor1&);
//   Tensor1a& operator= (const Tensor1a& o_) {if (__AdjustAdd(o_)) pData->operator=(*o_.pData); return *this;}
//   Tensor1a& operator-=(const Tensor1a&);
//   Tensor1a& operator+=(const Tensor1a& o_) {if (__AdjustAdd(o_)) pData->operator+=(*o_.pData); return *this;}
//   Tensor1a& operator*=(real_t v_) {return is0()? *this : (pData->operator*=(v_),*this);}
...
//   RetTensor1 operator/(real_t) const;
//   Tensor1a& Negate()     {return is0()? *this : (pData->Negate(),*this);}
//   real_t   Length() const {return is0()? 0.l : pData->Length();}
//   Tensor1a& Normalize();
//   Tensor1a& Assign0()    {delete pData; pData=NULL; return *this;}
//   Tensor1a& Assign1(small_t i_, real_t v_=1.l) {if (is0()) pData=new Tensor1s(true,i_,v_); else pData->Assign1(i_,v_); return *this;}
//   Tensor1a& Assign (small_t i_, real_t v_)     {if (is0()) pData = new Tensor1s(0.l); pData->Data[--i_]=v_; return *this;}
//   Tensor1a& Assign (real_t x_, real_t y_,real_t z_) {is0() ? pData = new Tensor1s(x_,y_,z_) : &pData->Assign(x_,y_,z_); return *this;}
//   Tensor1a& Add(small_t i_, real_t v_)     {if (is0()) pData = new Tensor1s(0.l); pData->Data[--i_]+=v_; return *this;}
//   Tensor1a& CrossMultiplyByBasisVector     (small_t i_) {return is0()? *this : (pData->CrossMultiplyByBasisVector(i_),*this);}
//   Tensor1a& CrossMultiplyByBasisVector_left(small_t i_) {return is0()? *this : (pData->CrossMultiplyByBasisVector_left(i_),*this);}
//   Tensor1a& CrossProductWithBasisVector     (small_t i_, Tensor1a& r_) const {return (r_=*this).CrossMultiplyByBasisVector(i_);}
//   Tensor1a& CrossProductWithBasisVector_left(small_t i_, Tensor1a& r_) const {return (r_=*this).CrossMultiplyByBasisVector_left(i_);}
//   RetTensor1 CrossProductWithBasisVector(small_t) const;
//   RetTensor1 CrossProductWithBasisVector_left(small_t) const;
//   real_t    DotProduct         (const Tensor1a& o_) const {return is0() || o_.is0() ? 0.l : pData->DotProduct(*o_.pData);}
//   Tensor1a& CrossMultiply      (const Tensor1a& o_) {if (__AdjustMult(o_)) pData->CrossMultiply(*o_.pData); return *this;}
//   Tensor1a& CrossMultiply_left (const Tensor1a& o_) {if (__AdjustMult(o_)) pData->CrossMultiply_left(*o_.pData); return *this;}
//   Tensor1a& CrossProduct       (const Tensor1a& o_, Tensor1a& r_) const {return o_.is0()? r_.Assign0() : (r_=*this).CrossMultiply(o_);}
...
//   Tensor4s&  CrossProduct       (const Tensor4s&, Tensor4s&) const;
//};
////inline std::ostream& operator<< (std::ostream& out_, const Tensor1s& t_) {return out_<<"| "<<t_[0]<<" "<<t_[1]<<" "<<t_[2]<<" |\n";}
////inline std::ostream& operator<< (std::ostream& out_, const Tensor1a& t_) {return out_<<"| "<<t_[0]<<" "<<t_[1]<<" "<<t_[2]<<" |\n";}
////------------------------------------------------------------------------------
//class RetTensor1
//{
// friend class Tensor1a;
// friend class Tensor2a;
//   mutable Tensor1s* pData;
//   RetTensor1(): pData(NULL) {}
//   RetTensor1(Tensor1a& o_): pData(o_.pData) {o_.pData = NULL;}
////   RetTensor1(const RetTensor1& o_): pData(o_.pData) {o_.pData = NULL;}
////   explicit RetTensor1(const real_t* const p_): pData(p_==NULL ? NULL : new Tensor1s(p_)) {}
//   RetTensor1(real_t x_, real_t y_, real_t z_): pData(new Tensor1s(x_,y_,z_)) {}
// public:
//   ~RetTensor1() {delete pData;}
//};
////------------------------------------------------------------------------------
////------------------------------------------------------------------------------
...
//   real_t* /*const*/ Rows[3];
//
//   #define __SET_ROWS   *Rows = Data; Rows[1] = Data+3; Rows[2] = Data+6;
////   void __set_rows(){const_cast<real_t*>(*Rows) = Data; const_cast<real_t*>(Rows[1]) = Data+3; const_cast<real_t*>(Rows[2]) = Data+6;}
//   const real_t* operator[](small_t i_) const {return Rows[i_];}
//         real_t* operator[](small_t i_)       {return Rows[i_];}
//   void __Assign(real_t v_) {std::fill(Data,Data+9,v_);}
//   void __Assign(const real_t* v_) {std::copy(v_,v_+9,Data);}
//   template<typename T> void __Assign2D         (const T v_) {for(small_t i=0,j; i<3; ++i)  for(j=0; j<3; ++j)   Rows[i][j] = v_[i][j];}
//   template<typename T> void __Assign2DTranspose(const T v_) {for(small_t i=0,j; i<3; ++i)  for(j=0; j<3; ++j)   Rows[i][j] = v_[j][i];}
...
// public:
//   Tensor2s() {__SET_ROWS;}
//   Tensor2s(tensor_kind_t, real_t v_=0.l) {__SET_ROWS; Assign1(v_);}
//   explicit Tensor2s(real_t v_) {__SET_ROWS; __Assign(v_);}
//   explicit Tensor2s(const real_t (*v_)[3]) {__SET_ROWS; __Assign2D(v_);}
//   explicit Tensor2s(const real_t **v_)     {__SET_ROWS; __Assign2D(v_);}
//   Tensor2s(const real_t (*v_)[3],bool) {__SET_ROWS; __Assign2DTranspose(v_);}
//   Tensor2s(const real_t **v_,    bool) {__SET_ROWS; __Assign2DTranspose(v_);}
//   Tensor2s(const Tensor1s&, const Tensor1s&, const Tensor1s&);
//   Tensor2s(const Tensor1s&, const Tensor1s&, const Tensor1s&, bool);
//   Tensor2s(const Tensor2s& o_)       {__SET_ROWS; __Assign(o_.Data);}
//   Tensor2s(const Tensor2s& o_, bool) {__SET_ROWS; __Assign2DTranspose(o_.Rows);}
//   const real_t& operator()(small_t, small_t) const;
//         real_t& operator()(small_t, small_t);
//   Tensor2s& operator=(const Tensor2s&);
//   Tensor2s& operator-=(const Tensor2s&);
//   Tensor2s& operator+=(const Tensor2s&);
//   Tensor2s& operator*=(real_t v_) {std::for_each(Data, Data+9, fMilt<real_t,real_t>(v_)); return *this;}
//   Tensor2s operator*(real_t v_) const {return Tensor2s(*this) *= v_;}//tmp to remove
//   Tensor2s& operator/=(real_t);
//   Tensor2s& Negate() {std::transform(Data, Data+9, Data, std::negate<real_t>()); return *this;}
//   Tensor2s& Transpose();
...
//   Tensor2s& Assign0() {__Assign(0.l); return *this;}
//   Tensor2s& Assign1(real_t v_=1.l) {__Assign(0.l); Data[0] = Data[4] = Data[8] = v_; return *this;}
//   real_t Contraction() const {return Data[0] + Data[4] + Data[8];}
//   real_t Det() const;
//   real_t I1()/*Linear    invariant*/ const {return Contraction();}
...
//   small_t EigenVectors(real_t/*current e.value*/, Tensor2s&/*e.vects*/, small_t=1/*begin position*/) const;
//   void Eigen(real_t[3],Tensor2s&) const;
//   Tensor2s& EigenVectors(Tensor2s& r_) const {real_t evs[3]; Eigen(evs,r_); return r_;}
//   Tensor2s& RotateToEigenSystem(Tensor2s&);
//   Tensor2s& AssignDev();
//   Tensor2s& Dev(Tensor2s& dev_) const {return (dev_=*this).AssignDev();}
...
//   Tensor2s* pData;
// private:
//   Tensor2s* __pData() {return is0() ? (pData=new Tensor2s) : pData;}
//   bool __AdjustAdd(const Tensor2a& o_) {return is0() ? (o_.is0() ? false : (pData=new Tensor2s(*o_.pData),false)) : (o_.is0() ? false : true);}
//   template <typename T>
//        bool __AdjustMult(const T& o_) {return is0() ? false : (o_.is0() ? Assign0(),false : true);}
//   template <typename Tfactor, typename Tresult>
//        bool __AdjustMult(const Tfactor& o_, Tresult& r_)const {return is0() || o_.is0()  ?  r_.Assign0(), false : true;}
//   const real_t* operator[](small_t i_) const {return pData->operator[](i_);}
// protected:
////   Tensor2a(Tensor2s* addr_): pData(addr_) {}
// public:
//   Tensor2a(): pData(NULL) {}
//   explicit Tensor2a(const Tensor2s& o_): pData(new Tensor2s(o_)) {}
//   Tensor2a(const Tensor2a& o_): pData(o_.is0()? (Tensor2s*)NULL : new Tensor2s(*o_.pData)) {}
//   Tensor2a(RetTensor2&);
//   virtual ~Tensor2a() {delete pData;}
//   bool is0() const {return pData==NULL;}
//   bool is0(small_t,small_t) const {return pData==NULL;}
//   const real_t& operator()(small_t,small_t) const;
//         real_t& operator()(small_t,small_t);
//   Tensor2a& operator= (RetTensor2&);
//   Tensor2a& operator= (const Tensor2s& o_) {if (is0()) pData = new Tensor2s(o_); else pData->operator=(o_); return *this;}
//   Tensor2a& operator= (const Tensor2a& o_) {if (__AdjustAdd(o_)) pData->operator=(*o_.pData); return *this;}
//   Tensor2a& operator-=(const Tensor2a&);
//   Tensor2a& operator+=(const Tensor2a& o_) {if (__AdjustAdd(o_)) pData->operator+=(*o_.pData); return *this;}
//   Tensor2a& operator+=(Tensor2CaptureDataAdapter);
//   Tensor2a& operator*=(real_t v_) {return is0()? *this : (pData->operator*=(v_),*this);}
...
//   RetTensor2 operator/(real_t) const;
//   real_t Contraction()const{return is0()? 0.l : pData->Contraction();}
//   real_t Det() const       {return is0()? 0.l : pData->Det();}
//   real_t I1() const {return Contraction();}
//   real_t I2() const {return is0()? 0.l : pData->I2();}
//   real_t I3() const {return Det();}
//   real_t Minor(small_t i_, small_t j_)const {return is0()? 0.l : pData->Minor(i_,j_);}
//   Tensor2a& Negate()   {return is0()? *this : (pData->Negate(),*this);}
//   Tensor2a& Transpose()  {return is0()? *this : (pData->Transpose(),*this);}
//   Tensor2a& AddTransposed(const Tensor2a& o_) {return is0() ? (o_.is0() ? *this : (pData=new Tensor2s(*o_.pData,false),*this)) : (o_.is0() ? *this : (pData->AddTransposed(*o_.pData),*this));}
//   Tensor2a& AddTransposed(Tensor2CaptureDataAdapter);
//   Tensor2a& Invert();
//   Tensor2a& Assign0()    {delete pData; pData=NULL; return *this;}
//   Tensor2a& Assign0toData(){pData->Assign0(); return *this;}
//   Tensor2a& Assign1(real_t v_=1.l) {if (is0()) pData = new Tensor2s(eUnit,v_); else pData->Assign1(v_); return *this;}
////   Tensor2& AssignRows(const Tensor1& r1_, const Tensor1& r2_, const Tensor1& r3_) {return r1_.is0()&&r2_.is0()&&r3_.is0()? (Assign0(),*this) : (AllocData(),pData->AssignRows(r1_,r2_,r3_),*this);}
////   Tensor2& AssignCols(const Tensor1& r1_, const Tensor1& r2_, const Tensor1& r3_) {return r1_.is0()&&r2_.is0()&&r3_.is0()? (Assign0(),*this) : (AllocData(),pData->AssignCols(r1_,r2_,r3_),*this);}
////   Tensor1s& EigenValues(Tensor1s& r_) const {return is0()? r_.Assign0() : pData->EigenValues(r_);}
////   small_t EigenVectors(real_t ev_, Tensor2& evc_, small_t p_=1) const {return is0()? (evc_.Assign0(),3) : pData->EigenVectors(ev_,evc_,p_);}
////   Tensor2& RotateToEigenSystem(Tensor2& r_) {return is0()? (r_.Assign1(),*this) : (pData->RotateToEigenSystem(r_),*this);}
////   Tensor1& AttachedVector(Tensor1& r_) const {return is0()? r_.Assign0() : pData->AttachedVector(r_);}
//   Tensor2a& AssignDev() {return is0()? *this : (pData->AssignDev(),*this);}
//   Tensor2a& Dev(Tensor2a& dev_) const {return (dev_ = *this).AssignDev();}
////   Tensor1& ScalarProductWithBasisVector     (small_t i_, Tensor1& r_) const {return is0()? r_.Assign0() : pData->ScalarProductWithBasisVector(i_,r_);}
////   Tensor1& ScalarProductWithBasisVector_left(small_t i_, Tensor1& r_) const {return is0()? r_.Assign0() : pData->ScalarProductWithBasisVector_left(i_,r_);}
//   Tensor1a& DotProduct        (const Tensor1a& o_, Tensor1a& r_) const {return is0()? r_.Assign0() : (r_=o_).DotMultiply_left(*this);}
//   RetTensor1 DotProduct  (const Tensor1a& o_) const {Tensor1a result; return DotProduct(o_,result);}
//   Tensor2a& CrossMultiply     (const Tensor1a& o_) {if (__AdjustMult(o_)) pData->CrossMultiply(*o_.pData); return *this;}
//   Tensor2a& CrossMultiply_left(const Tensor1a& o_) {if (__AdjustMult(o_)) pData->CrossMultiply_left(*o_.pData); return *this;}
//   Tensor2a& CrossProduct      (const Tensor1a& o_, Tensor2a& r_) const {return o_.is0()? r_.Assign0() : (r_=*this).CrossMultiply(o_);}
//   RetTensor2 CrossProduct(const Tensor1a&) const;
//   Tensor3s&  DirectProduct     (const Tensor1a&, Tensor3s&) const;
//   real_t    Dot2Product       (const Tensor2a& o_) const              {return is0()||o_.is0()? 0.l : pData->Dot2Product(*o_.pData);}
//   Tensor2a& DotMultiply       (const Tensor2a& o_) {if (__AdjustMult(o_)) pData->DotMultiply(*o_.pData); return *this;}
//   Tensor2a& DotMultiply_left  (const Tensor2a& o_) {if (__AdjustMult(o_)) pData->DotMultiply_left(*o_.pData); return *this;}
//   Tensor2a& DotProduct        (const Tensor2a& o_, Tensor2a& r_) const {return o_.is0()? r_.Assign0() : (r_ = *this).DotMultiply(o_);}
...
//   RetTensor1 Dot2Product (const Tensor3s& o_) const {Tensor1a result; return Dot2Product(o_,result);}
//   Tensor3s&  DotProduct        (const Tensor3s&, Tensor3s&) const;
//   Tensor4s&  CrossProduct      (const Tensor3s&, Tensor4s&) const;
...
//   Tensor4s&  DotProduct        (const Tensor4s&, Tensor4s&) const;
////   Tensor2& ApplyFunction(const fClassicFunction& fun_) {AllocData(0.l); pData->ApplyFunction(fun_); return *this;}
//};
...
// friend class Tensor1a;
// friend class Tensor2a;
//   mutable Tensor2s* pData;
//   RetTensor2(): pData(NULL) {}
//   RetTensor2(Tensor2a& o_): pData(o_.pData) {o_.pData = NULL;}
////   RetTensor2(const RetTensor2& o_): pData(o_.pData) {o_.pData = NULL;}
////   RetTensor2(const real_t* const p_): pData(p_==NULL ? NULL : new Tensor1s(p_)) {}
////   RetTensor2(real_t x_, real_t y_, real_t z_): pData(new Tensor1s(x_,y_,z_)) {}
// public:
//   bool is0() const {return pData==NULL;}
//   ~RetTensor2() {delete pData;}
...
//   Tensor2a& Ref;
// public:
//   explicit Tensor2CaptureDataAdapter(Tensor2a& o_): Ref(o_) {}
//};
////------------------------------------------------------------------------------
//class SymmetricTensor2s
//{
//   friend class Tensor2s;
//   real_t Data[6];  // 11 22 33 12 23 31
//
//   void __Assign(real_t v_) {std::fill(Data,Data+6,v_);}
//   void __Assign(const real_t* v_) {std::copy(v_,v_+6,Data);}
// public:
//   SymmetricTensor2s() {}
//////   Tensor2s(tensor_kind_t, real_t v_=0.l) {__SET_ROWS; Assign1(v_);}
//   explicit SymmetricTensor2s(real_t v_) {__Assign(v_);}
//   SymmetricTensor2s(const SymmetricTensor2s& o_)       {__Assign(o_.Data);}
//   real_t operator()(small_t, small_t) const;
////         real_t& operator()(small_t, small_t);
////   SymmetricTensor2s& operator=(const SymmetricTensor2s&);
////   SymmetricTensor2s& operator-=(const SymmetricTensor2s&);
//   SymmetricTensor2s& operator+=(const SymmetricTensor2s& o_) {Data[0]+=o_.Data[0]; Data[1]+=o_.Data[1]; Data[2]+=o_.Data[2]; Data[3]+=o_.Data[3]; Data[4]+=o_.Data[4]; Data[5]+=o_.Data[5]; return *this;}
//   SymmetricTensor2s& operator*=(real_t v_) {std::for_each(Data, Data+6, fMilt<real_t,real_t>(v_)); return *this;}
////   SymmetricTensor2s& operator/=(real_t);
//   SymmetricTensor2s operator*(real_t v_) {SymmetricTensor2s res(*this); return res*=v_;}
////   SymmetricTensor2s& Negate() {std::transform(Data, Data+6, Data, std::negate<real_t>()); return *this;}
//////   SymmetricTensor2s& Transpose() {return *this;}
//   SymmetricTensor2s& Assign0() {__Assign(0.l); return *this;}
//   SymmetricTensor2s& Assign1(real_t v_=1.l) {Data[0] = Data[1] = Data[2] = v_; Data[3] = Data[4] = Data[5] = 0.l; return *this;}
//   real_t Contraction() const {return Data[0] + Data[1] + Data[2];}
////   real_t Det() const;
//   real_t I1()/*Linear    invariant*/ const {return Contraction();}
////   real_t I2()/*Quadratic invariant*/ const;
////   real_t I3()/*Cubic     invariant*/ const {return Det();}
...
//////   Tensor1s  ScalarProductWithBasisVector_left(small_t) const;
////   void EigenValues(real_t[3]) const;
//////   small_t EigenVectors(real_t/*current e.value*/, SymmetricTensor2s&/*e.vects*/, small_t=1/*begin position*/) const;
//////   void Eigen(real_t[3],SymmetricTensor2s&) const;
//////   SymmetricTensor2s& EigenVectors(SymmetricTensor2s& r_) const {real_t evs[3]; Eigen(evs,r_); return r_;}
//////   SymmetricTensor2s& RotateToEigenSystem(SymmetricTensor2s&);
//   SymmetricTensor2s& AssignDev();
//   SymmetricTensor2s& Dev(SymmetricTensor2s& dev_) const {return (dev_=*this).AssignDev();}
////   Tensor1s& DotProduct      (const Tensor1s&, Tensor1s&) const;
...
//{
//#ifdef STRONGCHECK
// Assert(i_>0 && j_>0 && i_<=3 && j_<=3, "invalid index in SymmetricTensor2s::operator() const");
//#endif
...
//   pArr33_t Rows[3];
//   #define __SET_ROWS3   *Rows = static_cast<pArr33_t>(static_cast<void*>(Data)); Rows[1] = static_cast<pArr33_t>(static_cast<void*>(Data+9)); Rows[2] = static_cast<pArr33_t>(static_cast<void*>(Data+18));
//   void __Assign(real_t v_) {std::fill(Data,Data+27,v_);}
//   void __Assign(const real_t* v_) {std::copy(v_,v_+27,Data);}
//   const Arr33_t& operator[](small_t i_) const {return *Rows[i_];}
//         Arr33_t& operator[](small_t i_)       {return *Rows[i_];}
//   struct tIndex
//     {
//      private:
...
//       small_t  operator[](small_t) const;
//       small_t& operator[](small_t);
//       tIndex&     operator()(small_t i_, small_t j_, small_t k_){first=i_;second=j_;third=k_;return *this;}
//     };
// public:
//   Tensor3s() {__SET_ROWS3}
//   Tensor3s(tensor_kind_t, real_t v_=1.l) {__SET_ROWS3; Assign1(v_);}//Levy-Chivita
//   explicit Tensor3s(real_t v_) {__SET_ROWS3; __Assign(v_);}
//   Tensor3s(const Tensor3s& o_) {__SET_ROWS3; __Assign(o_.Data);}
...
//   Tensor3s& operator-=(const Tensor3s&);
//   Tensor3s& operator+=(const Tensor3s&);
//   Tensor3s& operator*=(real_t v_) {std::for_each(Data, Data+27, fMilt<real_t,real_t>(v_)); return *this;}
//   Tensor3s& operator/=(real_t);
//   Tensor3s& Negate() {std::transform(Data, Data+27, Data, std::negate<real_t>()); return *this;}
//   bool     is0() const {return false;}
//   Tensor3s& Assign0() {__Assign(0.l); return *this;}
//   Tensor3s& Assign1(real_t=1.l);//Levy-Chivita
...
//       public:
//        tIndex() {}
//        tIndex(const small_t i_,const small_t j_,const small_t k_,const small_t l_) {indices[0]=i_; indices[1]=j_; indices[2]=k_; indices[3]=l_;}
//        small_t  operator[](small_t) const;
//        small_t& operator[](small_t);
//      };
...
//   pArr333_t Rows[3];
//   #define __SET_ROWS4   *Rows = static_cast<pArr333_t>(static_cast<void*>(Data)); Rows[1] = static_cast<pArr333_t>(static_cast<void*>(Data+27)); Rows[2] = static_cast<pArr333_t>(static_cast<void*>(Data+54));
//   void __Assign(real_t v_) {std::fill(Data,Data+81,v_);}
//   void __Assign(const real_t* v_) {std::copy(v_,v_+81,Data);}
//   const Arr333_t& operator[](small_t i_) const {return *Rows[i_];}
//         Arr333_t& operator[](small_t i_)       {return *Rows[i_];}
//   /*virtual*/ real_t  operator[](tIndex) const;
//   /*virtual*/ real_t& operator[](tIndex);
// public:
//   Tensor4s() {__SET_ROWS4}
//   Tensor4s(tensor_kind_t, small_t kind_, real_t v_=1.l) {__SET_ROWS4; Assign1(kind_,v_);}//four isotropic tensors
//   explicit Tensor4s(real_t v_) {__SET_ROWS4; __Assign(v_);}
//   explicit Tensor4s(const SymmetricTensor4s&);
//   Tensor4s(const Tensor4s& o_) {__SET_ROWS4; __Assign(o_.Data);}
...
//   Tensor4s& operator-= (const Tensor4s&);
//   Tensor4s& operator+= (const Tensor4s&);
//   Tensor4s& operator*=(real_t v_) {std::for_each(Data, Data+81, fMilt<real_t,real_t>(v_)); return *this;}
//   Tensor4s& operator/=(real_t);
//   Tensor4s& Negate() {std::transform(Data, Data+81, Data, std::negate<real_t>()); return *this;}
//   Tensor4s& Assign0(small_t,small_t,small_t,small_t);
//   Tensor4& Assign0() {__Assign(0.l); return *this;}
//   Tensor4s& Assign1(small_t, real_t=1.l);//three isotropic tensors
...
// friend class Tensor2s;
// private:
//    real_t Data[21];//11..16,22..26,33..36,44..46,55,56,66
//
//   void __Assign(real_t v_) {std::fill(Data,Data+21,v_);}
//   void __Assign(const real_t* v_) {std::copy(v_,v_+21,Data);}
//   /*virtual*/ real_t operator[](tIndex) const;
// public:
//    real_t operator()(small_t,small_t) const;
//    real_t& operator()(small_t,small_t);
//    real_t operator()(small_t,small_t,small_t,small_t) const;
//   SymmetricTensor4s& Assign0() {__Assign(0.l); return *this;}
...
////==========================Tensor1s============================================
////------------------------------------------------------------------------------
//inline Tensor1s::Tensor1s(tensor_kind_t, small_t number_, real_t v_)//Basis vector multiplied by v_
//{
//#ifdef STRONGCHECK
// Assert(number_>0 && number_<=3, "invalid number of coordinate in Tensor1s::Tensor1s(bool,small_t,real_t)");
//#endif
// Data[--number_] = v_;   Data[number_==0?1:0] = Data[number_==2?1:2] = 0.l;
//}
////------------------------------------------------------------------------------
//inline Tensor1s::Tensor1s(const real_t* const p_)
//{
//#ifdef STRONGCHECK
// Assert(p_!=NULL, "non-allocated data in Tensor1s::Tensor1s(const real_t* const)");
//#endif
// __Assign(p_);
//}
////------------------------------------------------------------------------------
...
//
//#ifdef STRONGCHECK
// Assert(NE0(v_), "zero divisor in Tensor1s::operator/=(real_t)");
//#endif
// return operator*=(1.l/v_);
//}
////------------------------------------------------------------------------------
...
// real_t data_0 = Data[0],  data_1 = Data[1];
...
////==========================Tensor1a=============================================
////------------------------------------------------------------------------------
//inline Tensor1a::Tensor1a(RetTensor1& o_): pData(o_.pData)
//{
// o_.pData = NULL;
//}
////------------------------------------------------------------------------------
...
//{
//#ifdef STRONGCHECK
// Assert(!is0(), "NULL data in Tensor1a::operator()const");
//#endif
...
//{
//#ifdef STRONGCHECK
// Assert(!is0(), "NULL data in Tensor1a::operator()");
//#endif
// return pData->operator()(i_);
//}
////------------------------------------------------------------------------------
...
//{
//#ifdef STRONGCHECK
// Assert(NE0(v_), "zero divisor in Tensor1a::operator/=(real_t)");
//#endif
...
//{
// return is0() ? RetTensor1() : RetTensor1(-pData->Data[0], -pData->Data[1], -pData->Data[2]);
//}
////------------------------------------------------------------------------------
...
//{
//#ifdef STRONGCHECK
// Assert(i_[1]>=0 && i_[1]<3 && i_[2]>=0 && i_[2]<3, "invalid index in Tensor2s::operator[]const");
//#endif
...
//{
//#ifdef STRONGCHECK
// Assert(i_[1]>=0 && i_[1]<3 && i_[2]>=0 && i_[2]<3, "invalid index in Tensor2s::operator[]");
//#endif
// return Rows[i_[1]][i_[2]];
//}
////------------------------------------------------------------------------------
...
//{
//#ifdef STRONGCHECK
// Assert(i_>0 && j_>0 && i_<=3 && j_<=3, "invalid index in real_t Tensor2s::operator() const");
//#endif
// return Rows[--i_][--j_];
//}
////------------------------------------------------------------------------------
...
//{
//#ifdef STRONGCHECK
// Assert(NE0(v_), "zero divisor in Tensor2s::operator/=(real_t)");
//#endif
// return operator*=(1.l/v_);
//}
////------------------------------------------------------------------------------
...
// if (&o_==this)
//   {
//    Data[0]+=Data[0]; Data[1]+=Data[3]; Data[2]+=Data[6];
//    Data[3]=Data[1]; Data[4]+=Data[4]; Data[5]+=Data[7];
//    Data[6]=Data[2]; Data[7]=Data[5]; Data[8]+=Data[8];
//   }
// else
//   {
//    Data[0]+=o_.Data[0]; Data[1]+=o_.Data[3]; Data[2]+=o_.Data[6];
//    Data[3]+=o_.Data[1]; Data[4]+=o_.Data[4]; Data[5]+=o_.Data[7];
//    Data[6]+=o_.Data[2]; Data[7]+=o_.Data[5]; Data[8]+=o_.Data[8];
//   }
// return *this;
//}
////------------------------------------------------------------------------------
...
// result_.Data[0]=Data[0]+Data[0];  result_.Data[3]=Data[1]+Data[3];  result_.Data[5]=Data[2]+Data[6];
//                                   result_.Data[1]=Data[4]+Data[4];  result_.Data[4]=Data[5]+Data[7];
...
//{
// return Data[0]*Data[4] + Data[4]*Data[8] + Data[8]*Data[0] -
//        Data[1]*Data[3] - Data[5]*Data[7] - Data[6]*Data[2];
//}
////------------------------------------------------------------------------------
//inline Tensor1s& Tensor2s::AttachedVector(Tensor1s& result_) const
//{
// return result_.Assign(0.5l * (Data[7] - Data[5]),
//                       0.5l * (Data[2] - Data[6]),
//                       0.5l * (Data[3] - Data[1]));
//}
////------------------------------------------------------------------------------
...
//{
// return Tensor1s(0.5l * (Data[7] - Data[5]),
//                      0.5l * (Data[2] - Data[6]),
//                      0.5l * (Data[3] - Data[1]));
//}
////------------------------------------------------------------------------------
...
//{
// --i_;
// return Tensor1s(Rows[0][i_],Rows[1][i_],Rows[2][i_]);
//}
////------------------------------------------------------------------------------
//inline Tensor1s Tensor2s::ScalarProductWithBasisVector_left (small_t i_) const
//{
// --i_;
// return Tensor1s(Rows[i_][0],Rows[i_][1],Rows[i_][2]);
//}
////------------------------------------------------------------------------------
//inline Tensor2s& Tensor2s::AssignDev()
//{
// const real_t p = I1()/3.l;
// Data[0] -= p; Data[4] -= p; Data[8] -= p;
// return *this;
//}
////------------------------------------------------------------------------------
...
////==========================Tensor2a=============================================
////------------------------------------------------------------------------------
//inline Tensor2a::Tensor2a(RetTensor2& o_): pData(o_.pData)
//{
// o_.pData = NULL;
//}
////------------------------------------------------------------------------------
...
//{
//#ifdef STRONGCHECK
// Assert(!is0(), "NULL data in Tensor2a::operator()const");
//#endif
...
//{
//#ifdef STRONGCHECK
// Assert(!is0(), "NULL data in Tensor2a::operator()");
//#endif
// return pData->operator()(i_,j_);
//}
////------------------------------------------------------------------------------
...
//{
// if (is0())
//    {pData=o_.Ref.pData; o_.Ref.pData=NULL;}
// else if (!o_.Ref.is0())
...
//{
//#ifdef STRONGCHECK
// Assert(!is0(), "NULL data in Tensor2a::Invert()");
//#endif
// pData->Invert();
// return *this;
//}
...
//{
//#ifdef STRONGCHECK
// Assert(NE0(v_), "zero divisor in Tensor2a::operator/=(real_t)");
//#endif
// return is0()? *this : (pData->operator/=(v_),*this);
//}
////------------------------------------------------------------------------------
...
//{
//#ifdef STRONGCHECK
// Assert(i_[1] < 3  &&  i_[2] < 3  &&  i_[3] < 3, "invalid index in Tensor3s::operator[](tIndex3)const");
//#endif
...
//{
//#ifdef STRONGCHECK
// Assert(i_>0 && j_>0 && k_>0 && i_<=3 && j_<=3 && k_<=3, "invalid index in Tensor3s::operator()const");
//#endif
...
//{
//#ifdef STRONGCHECK
// Assert(i_>0 && j_>0 && k_>0 && i_<=3 && j_<=3 && k_<=3, "invalid index in Tensor3s::operator()");
//#endif
// return (*Rows[--i_])[--j_][--k_];
//}
////------------------------------------------------------------------------------
...
//{
//#ifdef STRONGCHECK
// Assert(NE0(v_),"suspicious absence of exception in Tensor3s::operator/=(real_t)");
//#endif
// return operator*=(1.l/v_);
//}
////------------------------------------------------------------------------------
...
//{
//#ifdef STRONGCHECK
// Assert(i_>0 && j_>0 && k_>0 && l_>0 && i_<=3 && j_<=3 && k_<=3 && l_<=3, "invalid index in Tensor4s::operator[](small_t,small_t,small_t,small_t)const");
//#endif
...
//{
//#ifdef STRONGCHECK
// Assert(i_>0 && j_>0 && k_>0 && l_>0 && i_<=3 && j_<=3 && k_<=3 && l_<=3, "invalid index in Tensor4s::operator[](small_t,small_t,small_t,small_t)");
//#endif
// return (*Rows[--i_])[--j_][--k_][--l_];
//}
////------------------------------------------------------------------------------
...
//{
//#ifdef STRONGCHECK
// Assert(NE0(v_), "suspicious absence of exception in Tensor4s::operator/=(real_t)");
//#endif
// return operator*=(1.l/v_);
//}
////------------------------------------------------------------------------------
...
//{
//#ifdef STRONGCHECK
// Assert(i_>0 && j_>0 && k_>0 && l_>0 && i_<=3 && j_<=3 && k_<=3 && l_<=3, "invalid index in Tensor4s::Assign0(small_t,small_t,small_t,small_t)");
//#endif
// (*Rows[--i_])[--j_][--k_][--l_] = 0.l;
// return *this;
//}
////------------------------------------------------------------------------------
...
// #endif
// using std::SQRTL;
// Tensor2s l; l(1,1) = 1.l/SQRTL(2.l); l(1,2) = -1.l/SQRTL(2.l); l(1,3) = 0.l;
//             l(2,1) = 1.l/SQRTL(2.l); l(2,2) =  1.l/SQRTL(2.l); l(2,3) = 0.l;
//             l(3,1) = 0.l;            l(3,2) =  0.l;            l(3,3) = 1.l;
// const Tensor2s& q(l);
...
//      t809 = q(3,1)*t744,
//      t810 = q(2,1)*t749,
//      t815 = q(2,2)*(q(3,3)*(2.0*t468+q(2,1)*t742+t801)+q(2,3)*(q(3,1)*t742+2.0*t180+t806)+q(1,3)*(t809+t810+2.0*t170)),
//      t817 = q(2,1)*t744,
//      t818 = t758*q(1,1),
//      t822 = t763*q(1,1),
...
// static real_t g[6][6];
// g[0][0]=l(1,1)*l(1,1); g[0][1]=l(1,2)*l(1,2); g[0][2]=l(1,3)*l(1,3); g[0][3]=          2.l*l(1,2)*l(1,3); g[0][4]=          2.l*l(1,3)*l(1,1); g[0][5]=          2.l*l(1,2)*l(1,1);
// g[1][0]=l(2,1)*l(2,1); g[1][1]=l(2,2)*l(2,2); g[1][2]=l(2,3)*l(2,3); g[1][3]=          2.l*l(2,3)*l(2,2); g[1][4]=          2.l*l(2,3)*l(2,1); g[1][5]=          2.l*l(2,2)*l(2,1);
// g[2][0]=l(3,1)*l(3,1); g[2][1]=l(3,2)*l(3,2); g[2][2]=l(3,3)*l(3,3); g[2][3]=          2.l*l(3,3)*l(3,2); g[2][4]=          2.l*l(3,3)*l(3,1); g[2][5]=          2.l*l(3,2)*l(3,1);
// g[3][0]=l(3,1)*l(2,1); g[3][1]=l(3,2)*l(2,2); g[3][2]=l(3,3)*l(2,3); g[3][3]=l(3,3)*l(2,2)+l(3,2)*l(2,3); g[3][4]=l(3,3)*l(2,1)+l(3,1)*l(2,3); g[3][5]=l(3,1)*l(2,2)+l(3,2)*l(2,1);
// g[4][0]=l(3,1)*l(1,1); g[4][1]=l(3,2)*l(1,2); g[4][2]=l(3,3)*l(1,3); g[4][3]=l(3,3)*l(1,2)+l(3,2)*l(1,3); g[4][4]=l(3,3)*l(1,1)+l(3,1)*l(1,3); g[4][5]=l(3,1)*l(1,2)+l(3,2)*l(1,1);
// g[5][0]=l(2,1)*l(1,1); g[5][1]=l(1,2)*l(2,2); g[5][2]=l(1,3)*l(2,3); g[5][3]=l(1,3)*l(2,2)+l(1,2)*l(2,3); g[5][4]=l(1,1)*l(2,3)+l(1,3)*l(2,1); g[5][5]=l(1,1)*l(2,2)+l(1,2)*l(2,1);
//
///* g[0][0]=l(1,1)*l(1,1); g[0][1]=l(1,2)*l(1,2); g[0][2]=l(1,3)*l(1,3); g[0][4]=          2.l*l(1,2)*l(1,3); g[0][5]=          2.l*l(1,3)*l(1,1); g[0][3]=          2.l*l(1,2)*l(1,1);
// g[1][0]=l(2,1)*l(2,1); g[1][1]=l(2,2)*l(2,2); g[1][2]=l(2,3)*l(2,3); g[1][4]=          2.l*l(2,3)*l(2,2); g[1][5]=          2.l*l(2,3)*l(2,1); g[1][3]=          2.l*l(2,2)*l(2,1);
// g[2][0]=l(3,1)*l(3,1); g[2][1]=l(3,2)*l(3,2); g[2][2]=l(3,3)*l(3,3); g[2][4]=          2.l*l(3,3)*l(3,2); g[2][5]=          2.l*l(3,3)*l(3,1); g[2][3]=          2.l*l(3,2)*l(3,1);
// g[4][0]=l(3,1)*l(2,1); g[4][1]=l(3,2)*l(2,2); g[4][2]=l(3,3)*l(2,3); g[4][4]=l(3,3)*l(2,2)+l(3,2)*l(2,3); g[4][5]=l(3,3)*l(2,1)+l(3,1)*l(2,3); g[4][3]=l(3,1)*l(2,2)+l(3,2)*l(2,1);
// g[5][0]=l(3,1)*l(1,1); g[5][1]=l(3,2)*l(1,2); g[5][2]=l(3,3)*l(1,3); g[5][4]=l(3,3)*l(1,2)+l(3,2)*l(1,3); g[5][5]=l(3,3)*l(1,1)+l(3,1)*l(1,3); g[5][3]=l(3,1)*l(1,2)+l(3,2)*l(1,1);
// g[3][0]=l(2,1)*l(1,1); g[3][1]=l(1,2)*l(2,2); g[3][2]=l(1,3)*l(2,3); g[3][4]=l(1,3)*l(2,2)+l(1,2)*l(2,3); g[3][5]=l(1,1)*l(2,3)+l(1,3)*l(2,1); g[3][3]=l(1,1)*l(2,2)+l(1,2)*l(2,1);
...
//{
//#ifdef STRONGCHECK
// Assert(i_>0 && j_>0 && i_<=6 && j_<=6, "invalid index in SymmetricTensor4s::operator(small_t,small_t)const");
//#endif
// if (--i_ > --j_)
//         std::swap(i_,j_);
...
//{
//#ifdef STRONGCHECK
// Assert(i_>0 && j_<=6 && i_<=j_, tMessage("invalid index in SymmetricTensor4s::operator(small_t,small_t), must be 0<")<<i_<<"<="<<j_<<"<=6");
//#endif
...
//{//отображение индексов: 11->1, 22->2, 33->3, 12->4, 23->5, 13->6
//#ifdef STRONGCHECK
// Assert(i_>0 && j_>0 && k_>0 && l_>0 && i_<=3 && j_<=3 && k_<=3 && l_<=3, "invalid index in SymmetricTensor4s::operator(small_t i_,small_t,small_t i_,small_t)const");
//#endif
// return operator()(i_==j_ ? i_ : (25-3*(i_+j_))*(i_+j_)/2-20,  k_==l_ ? k_ : (25-3*(k_+l_))*(k_+l_)/2-20);
//}
////------------------------------------------------------------------------------
//inline real_t SymmetricTensor4s::operator[](Tensor4::tIndex i_) const
//{//отображение индексов: 00->1, 11->2, 22->3, 01->4, 12->5, 02->6
//#ifdef STRONGCHECK
// Assert(i_[1]>=0 && i_[2]>=0 && i_[3]>=0 && i_[4]>=0 && i_[1]<3 && i_[2]<3 && i_[3]<3 && i_[4]<3, "invalid index in SymmetricTensor4s::operator[]const");
//#endif
// return operator()(i_[1]==i_[2] ? (i_[1]+1) : (13-3*(i_[1]+i_[2]))*(i_[1]+i_[2])/2-1,  i_[3]==i_[4] ? (i_[3]+1) : (13-3*(i_[3]+i_[4]))*(i_[3]+i_[4])/2-1);
//}
////------------------------------------------------------------------------------
//inline real_t Tensor4s::operator[] (Tensor4::tIndex i_) const
//{
//#ifdef STRONGCHECK
// Assert(i_[1]>=0 && i_[2]>=0 && i_[3]>=0 && i_[4]>=0 && i_[1]<3 && i_[2]<3 && i_[3]<3 && i_[4]<3, "invalid index in Tensor4s::operator[](Index4)const");
//#endif
...
//{
//#ifdef STRONGCHECK
// Assert(i_[1]>=0 && i_[2]>=0 && i_[3]>=0 && i_[4]>=0 && i_[1]<3 && i_[2]<3 && i_[3]<3 && i_[4]<3, "invalid index in Tensor4s::operator[](Index4)");
//#endif
// return (*Rows[i_[1]])[i_[2]][i_[3]][i_[4]];
//}
////------------------------------------------------------------------------------
